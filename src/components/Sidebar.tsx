        ...
        <div className="p-3 border-t border-gray-200/50 dark:border-gray-800/80 space-y-2">
          ...
          >
            ...
            <div className="flex justify-between text-[10px] text-gray-400 mt-1">
              <span>
                {totalKnown} {getTranslation(uiLanguage, "learned")}
              </span>
              <span>
                {getTranslation(uiLanguage, "learnedOfWords", {
                  total: totalCards,
                })}
              </span>
            </div>
          ...
          <div className="flex items-center justify-between pt-1">
            <button
              ...
              title={
                isDarkMode
                  ? getTranslation(uiLanguage, "themeLight")
                  : getTranslation(uiLanguage, "themeDark")
              }
            >
              {isDarkMode ? (
    ...
    >
      <div className="flex items-center gap-2.5 min-w-0">
        ...
        <div className="flex flex-col truncate">
          ...
          <span className="text-[10px] text-gray-400 font-normal">
            {deck.cards.length} {getTranslation(uiLanguage, "wordsCountSuffix")}
            {" •"} {stats.percentage}%
          </span>
        </div>
      </div>
